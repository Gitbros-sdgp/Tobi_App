...
def audio_classify(argv):
    ...
    for file_name in argv:
        ...
        for i in top5_i:
            if yamnet_classes[i] == 'Bark':
                results.append(yamnet_classes[i])
                resultsPercentage.append(prediction[i])
            elif yamnet_classes[i] == 'Yip':
                results.append(yamnet_classes[i])
                resultsPercentage.append(prediction[i])
            elif yamnet_classes[i] == 'Howl':
                results.append(yamnet_classes[i])
                resultsPercentage.append(prediction[i])
            elif yamnet_classes[i] == 'Bow-wow':
                results.append(yamnet_classes[i])
                resultsPercentage.append(prediction[i])
            elif yamnet_classes[i] == 'Growling':
                results.append(yamnet_classes[i])
                resultsPercentage.append(prediction[i])
            elif yamnet_classes[i] == 'Whimper':
                results.append(yamnet_classes[i])
                resultsPercentage.append(prediction[i])
